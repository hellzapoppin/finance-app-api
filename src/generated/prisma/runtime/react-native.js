...
var Pi = Ae((rt) => {
    ...
    function ui(e, t, r) {
        ...
        if (
            ...
            (typeof SharedArrayBuffer < 'u' &&
                (he(e, SharedArrayBuffer) ||
                    (e && he(e.buffer, SharedArrayBuffer))))
        )
            return pi(e, t, r)
        if (typeof e == 'number')
            throw new TypeError(
    ...
    function Tt(e, t, r) {
        throw Math.floor(e) !== e
            ? (tt(e, r),
              new Xe.ERR_OUT_OF_RANGE(r || 'offset', 'an integer', e))
            : t < 0
...
S.minus = S.sub = function (e) {
    ...
    if (
        ((r = te(e.e / F)), (g = te(R.e / F)), (u = u.slice()), (o = g - r), o)
    ) {
        for (
            h = o < 0,
                h
...
S.plus = S.add = function (e) {
    ...
    if (
        ((o = te(h.e / F)), (n = te(e.e / F)), (u = u.slice()), (i = o - n), i)
    ) {
        for (
            i < 0
                ? ((r = u), (i = -i), (s = g.length))
...
function mo(e) {
    ...
    function i(o) {
        ...
        if (l === 'bigint')
            return (
                o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), ur(u, o.toString())
            )
        throw Error(qe + o)
    }
    if (
...
var Wn = (e, t = new Jn()) => {
        let r = {
            ...
            startTransaction: async (...n) =>
                (await _e(t, e.startTransaction.bind(e))(...n)).map((o) =>
                    Rp(t, o),
                ),
        }
        return (
...
${a.backtrace}`,
    ...
    getExternalAdapterError(t, r) {
        if (t.error_code === Op && r) {
            ...
            return (
                sr(i, 'External error with reported id was not registered'), i
            )
        }
    }
    async metrics(t) {
...
var Zn =
        ...
        (r) => {
            ...
            if (Lr(r))
                ...
                let [o, ...s] = r
                ;(n = o),
                    (i = { values: xt(s || []), __prismaRawParameters__: !0 })
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
